...
const BrandedCards: React.FC = () => {
  return (
    ...
    >
      <div className="relative flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-8 lg:gap-12">
        {/* Mobile: First Row */}
        <div className="flex flex-row justify-center items-center gap-3 sm:hidden">
          ...
          >
            {/* Card Container */}
            <motion.div
              className="w-24 aspect-[1.586/1] relative overflow-visible"
              style={{
        ...
        <div className="flex flex-row justify-center items-center gap-3 sm:hidden">
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 rounded-3xl blur-2xl -z-10 py-8"
              style={{
                background: 'radial-gradient(ellipse at center, rgba(107, 114, 128, 0.4) 0%, transparent 70%)',
              }}
              animate={{ 
                scale: [1, 1.1, 1],
                opacity: [0.4, 0.7, 0.4]
        ...
        {/* Desktop: All cards in one row (hidden on mobile) */}
        <div className="hidden sm:flex sm:flex-row justify-center items-center gap-3 sm:gap-8 lg:gap-12">
          {/* MasterCard Black Card */}
          <motion.div
            className="relative group cursor-pointer"
            whileHover={{ 
