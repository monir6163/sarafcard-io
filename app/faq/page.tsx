  ...
  const faqData: FaqItem[] = [
    {
      ...
      answer:
        "SarafCard is the best Worldwide Spending Freedom offering instant virtual Visa and Mastercard prepaid cards. Perfect gift card alternative for global digital payments with instant activation and bank-level security. It enables secure, flexible digital payments and works with Apple Pay and Google Pay for seamless online and contactless transactions.",
    },
    {
      question: "How do I activate or redeem my card?",
      answer:
        "Visit the SarafCard dashboard, enter your redemption code and complete the identity verification process.",
      warning:
        "If you're connected via a VPN, using Tor, or accessing SarafCard from a restricted country, your redemption will automatically fail due to enforced security and compliance protocols.",
    },
    {
      question: "Where can I use SarafCard?",
      answer:
        "SarafCard is accepted at most online merchants and in-store terminals that support Visa or Mastercard, including contactless payments through Apple Pay or Google Pay.",
    ...
    },
    {
      ...
      answer:
        "Use of SarafCard is not allowed in certain countries due to regulatory restrictions and issuer policies.",
      restrictions: [
        "Afghanistan",
        "Algeria",
        "Angola",
    ...
    },
    {
      ...
      answer:
        "No. Accessing SarafCard via VPNs, Tor, or proxy networks will result in failed redemptions and may permanently block the card. Always use a secure, direct internet connection from a supported country.",
    },
    {
      question: "How long is my card valid?",
      answer:
        "Each SarafCard is valid for 3 years from the date of activation. The expiration is automatically enforced.",
    },
    {
      question: "What happens to my balance after the card expires?",
      answer:
        "Any remaining balance will be automatically dissolved after expiration. Funds are non-refundable and cannot be recovered once the card is expired.",
    },
    {
      question: "Can I cancel or return a card?",
      answer:
        "If your card has not been activated, contact the reseller from whom you purchased the card. If the card is already activated, it is considered final and non-refundable.",
    },
    {
      question: "Can I get a refund?",
      answer:
        "Refunds are only available for duplicate charges, mistaken billing, or verified technical failures during activation. Contact support@sarafcard.io with full documentation within 7–10 business days of the issue.",
    },
    {
      question: "How do I contact customer support?",
      answer:
        "You can reach our team through email at support@sarafcard.io or use the support request form when logged in to your dashboard. We typically respond within 1–2 business days.",
    },
    {
      question: "Is SarafCard secure?",
      answer:
        "Yes. SarafCard operates under strict security protocols, including PCI-DSS certified systems, tokenized card data, end-to-end encryption, and real-time fraud monitoring with IP restriction enforcement.",
    },
    {
      question: "Are there any fees or usage limits?",
      answer:
        "Yes. Each card may include FX fees for non-USD transactions, transaction limits per card or program, and processing or issuance fees if applicable. You can view all applicable fees and limits in the Terms section or within your dashboard prior to using the card.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-silver max-w-2xl mx-auto">
              Find answers to common questions about SarafCard, activation,
              usage, and policies.
            </p>
          </motion.div>
        </div>
                      ...
                      <div className="px-4 py-4 space-y-3">
                        ...
                        {faq.restrictions && (
                          <div className="bg-silver/5 rounded-lg p-3 border border-silver/10">
                            <p className="text-silver/80 text-sm mb-2 font-medium">
